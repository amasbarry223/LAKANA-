    ...
    <div className="flex h-full flex-col bg-[#070347] text-white select-none">
      ...
      <div className="relative border-t border-white/10 p-3 bg-[#050236]">
        ...
        {menuOpen && (
          <div
            className={cn(
              "absolute bottom-16 z-50 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl ring-1 ring-black/5 dark:border-slate-800 dark:bg-slate-900 dark:ring-white/10 dark:shadow-2xl animate-in fade-in-50 zoom-in-95 duration-150",
          ...
          >
            <div className="px-2.5 py-2 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-1.5 py-0.5 rounded-md">
                  <ShieldCheck className="h-3 w-3" />
                  Certifié LAKANA
                </span>
              </div>
              <p className="text-xs font-bold text-slate-900 dark:text-slate-100 mt-1">{userName}</p>
            ...
            <div className="py-1">
              <button
                ...
                className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-left text-xs font-medium text-slate-700 dark:text-slate-200 transition hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex w-full items-center justify-between rounded-lg px-2.5 py-1.5 text-left text-xs font-medium text-slate-700 dark:text-slate-200 transition hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer"
              >
            ...
            <button
              ...
              className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-left text-xs font-semibold text-rose-600 dark:text-rose-400 transition hover:bg-rose-50 dark:hover:bg-rose-950/40 cursor-pointer"
            >
      ...
      {confirmLogoutOpen && (
        ...
        >
          <div
            ...
            className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 dark:border dark:border-slate-800 p-6 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 mb-4">
              <LogOut className="h-6 w-6" />
            </div>
            <h3 id="logout-dialog-title" className="text-base font-bold text-slate-900 dark:text-slate-100">
              Confirmer la déconnexion
            </h3>
            <p id="logout-dialog-desc" className="mt-1 text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <div className="mt-5 flex items-center gap-2">
              <button
                type="button"
                onClick={() => setConfirmLogoutOpen(false)}
                className="flex-1 rounded-lg border border-slate-200 dark:border-slate-700 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition cursor-pointer"
              >
                Rester connecté
              </button>
              <button
