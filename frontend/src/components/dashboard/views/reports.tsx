                  ...
                  registreSuspectes.map((r, i) => (
                    <tr key={i} className="hover:bg-slate-50 transition">
                      ...
                      <td className="py-2.5 px-3 whitespace-nowrap">
                        <Badge variant="outline" className="text-[10px] bg-slate-50">{r.nature_operation}</Badge>
                      </td>
                ...
                {registre15M.length === 0 ? (
                  ...
                  registre15M.map((r, i) => (
                    <tr key={i} className="hover:bg-slate-50 transition">
                      ...
                      <td className="py-2.5 px-3 whitespace-nowrap">{r.profession}</td>
                      <td className="py-2.5 px-3 whitespace-nowrap">
                        <Badge variant="outline" className="text-[10px]">{r.nature_operation}</Badge>
                      </td>
        ...
        <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm space-y-4 p-5">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => window.print()}
                className="flex items-center gap-1.5 rounded-lg bg-violet-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-violet-700 shadow-sm"
              >
                <Printer className="h-3.5 w-3.5" />
                Imprimer Registre
              </button>
