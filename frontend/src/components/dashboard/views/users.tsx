...
export function UsersView() {
  ...
  const confirmDeleteUser = () => {
    ...
    toast.success("Utilisateur supprimé", { description: `${u.name} (${u.email}) a été supprimé avec succès.` })
        ...
        description={
          userToDelete ? (
            <span>
              ...
              Cette action est irréversible et sera enregistrée dans le journal d'audit (AUTH-12).
            </span>
          ) : null
        }
